 ...
 *
 */
@ExportableFor(clazz=uk.co.polycode.neo4j.data.PostalAddress.class)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public class PostalAddress {

	public static PostalAddress from(uk.co.polycode.neo4j.data.PostalAddress that) {
		return (PostalAddress) MappingUtils.reflectionDeepCopy(that, new PostalAddress());
	}
